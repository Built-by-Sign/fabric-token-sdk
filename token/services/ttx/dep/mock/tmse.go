...
func (fake *TokenManagementServiceWithExtensions) NewRequestFromBytes(arg1 token.RequestAnchor, arg2 []byte, arg3 []byte) (*token.Request, error) {
	var arg2Copy []byte
	if arg2 != nil {
...
func (fake *TokenManagementServiceWithExtensions) NewRequestFromBytesCallCount() int {
...
func (fake *TokenManagementServiceWithExtensions) NewRequestFromBytesCalls(stub func(token.RequestAnchor, []byte, []byte) (*token.Request, error)) {
	fake.newRequestFromBytesMutex.Lock()
	defer fake.newRequestFromBytesMutex.Unlock()
	fake.NewRequestFromBytesStub = stub
}

func (fake *TokenManagementServiceWithExtensions) NewRequestFromBytesArgsForCall(i int) (token.RequestAnchor, []byte, []byte) {
	fake.newRequestFromBytesMutex.RLock()
	defer fake.newRequestFromBytesMutex.RUnlock()
...
func (fake *TokenManagementServiceWithExtensions) NewRequestFromBytesReturns(result1 *token.Request, result2 error) {
	fake.newRequestFromBytesMutex.Lock()
	defer fake.newRequestFromBytesMutex.Unlock()
...
func (fake *TokenManagementServiceWithExtensions) NewRequestFromBytesReturnsOnCall(i int, result1 *token.Request, result2 error) {
	fake.newRequestFromBytesMutex.Lock()
	defer fake.newRequestFromBytesMutex.Unlock()
	fake.NewRequestFromBytesStub = nil
